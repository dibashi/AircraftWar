...
var _heroPlaneData = [
    { planeImage: "heroPlane0", blood: 1, shootingSpeed: 1, flyingSpeed: 20, bulletType: _heroBulletType.ordinary, damage: 1,wingmanBulletType:0,onceBulletCount:10 },//wingmanBulletType 决定加载哪个子弹预制体目前只实现了一个
